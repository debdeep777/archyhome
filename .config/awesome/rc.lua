...
mytextclock = awful.widget.textclock(markup(beautiful.colors.cyan, "%a ") .. markup(beautiful.colors.base02, "%d ") .. markup(beautiful.colors.blue, "%b") .. markup(beautiful.colors.base03, " %I:%M %p"))
...
fswidget = lain.widgets.fs({
    settings  = function()
        widget:set_markup(markup(beautiful.colors.yellow, fs_now.used .. "% "))
    end
})
...
batwidget = lain.widgets.bat({
    settings = function()
		...
		widget:set_markup(markup(beautiful.colors.red, bat_now.time))
        else
		widget:set_markup(markup(beautiful.colors.green, batperc))
        end
    end
})
...
memvbar:set_background_color(beautiful.colors.base03)
--memvbar:set_border_color(beautiful.colors.yellow)
memvbar:set_color({ type = "linear", from = { 0, 0 }, to = { 0, 15 }, stops = { {0, beautiful.colors.red}, {0.5, beautiful.colors.yellow}, 
...
bbar:set_background_color(beautiful.colors.red)
bbar:set_color(beautiful.colors.green)
...
-- Graph properties
cpuw:set_width(25)
cpuw:set_background_color(beautiful.colors.base00)
cpuw:set_color({ type = "linear", from = { 0, 0 }, to = { 10,0 }, stops = { {0,beautiful.colors.magenta}, {0.5, beautiful.colors.yellow}, 
                    {1, beautiful.colors.green }}})
                    -- Register widget
