...
run_once({ "nm-applet", "unclutter -root","xfce4-power-manager" })
-- run Onboard for touchscreens, courtesy: psychon from awesome iirc
run_once({ "onboard" })
-- xfsettingd will enable all the keyboard shortcuts from xfce env and mess with the awesome keybindings.
-- one main problem is it will launch xfce-terminal instead of xterm causing it to break (known bug)
--run_once({"xfsettingsd" })
-- }}}

-- {{{ Variable definitions
local chosen_theme = "dep"
local modkey       = "Mod4"
local altkey       = "Mod1"
