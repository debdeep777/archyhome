...
-- myscr script volcontrol, uses pactl, chooses the main sound card
 awful.button({ }, 4, function () awful.spawn("volcontrol +5%") theme.volumebar.update()       end),
 awful.button({ }, 5, function () awful.spawn("volcontrol -5%")  theme.volumebar.update()      end),
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Left widgets
            ...
            --spr,
            wibox.container.background(wibox.container.margin(s.mylayoutbox, 0, 0),"#EEEEEE"),
            s.mytaglist,
            s.mypromptbox,
            spr,
        },
