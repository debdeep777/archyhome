...
local bat = lain.widget.bat({
	...
	if perc >90 then
	  local baticon = wibox.widget.imagebox("/icon/icon_battery-full.png")
	elseif perc > 60 then
	  local baticon = wibox.widget.imagebox("/icon/icon_battery-half.png")
	elseif perc > 30 then
	  local baticon = wibox.widget.imagebox("/icon/icon_battery-half.png")
	elseif perc > 15 then
	  local baticon = wibox.widget.imagebox("/icon/icon_battery-quarter.png")
	else
	  local baticon = wibox.widget.imagebox("/icon/icon_battery-empty.png")
	end
...
--Onscreen keyboard
onboard = wibox.widget.textbox(" ONB ")
onboard:buttons(awful.util.table.join(
 awful.button({ }, 1, function () awful.util.spawn("onboard") end)
 ))       
