...
-- My Textclock
local datestring = markup.font(theme.font_small, markup(gl_bg0, " %b ")) .. markup.font(theme.font, markup(gl_fg0,"%d "))  
local timestring = markup.font(theme.font_small, markup(gl_bg0, "%a ")) .. markup.font(theme.font, markup(gl_fg0, "%I:%M" ))
   ...
   theme.weather = lain.widget.weather({
	...
	city_id = 4366164,  -- washington, DC
       ...
       settings = function()
           ...
           widget:set_markup(" " .. markup.font(theme.font_small, markup ( gl_fg0, units) ) .. " ")
       end
   })
...
local mem = lain.widget.mem({
	...
	---------------
        ...
        --widget:set_markup(markup.font(theme.font, markup( gl_bg0,  " " .. mem_now.used .. "MB ")) )
    end
})
...
local bat = lain.widget.bat({
    settings = function()
        if bat_now.status and bat_now.status ~= "N/A" then
            ...
            widget:set_markup(markup.font(theme.font_small, markup(gl_bg0, bat_now.perc .. " ") ))
...
function theme.at_screen_connect(s)
	...
	--volumebar,
	    ...
	    -- cpu
            arrow("#343434", gl_dark_yellow),
            wibox.container.background(wibox.container.margin(wibox.widget {mem, layout = wibox.layout.align.horizontal }, 0, 0), gl_dark_yellow),
	    ...
	    -- bat
           arrow(gl_dark_yellow, gl_light_aqua),
          ...
          -- wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 0, 0), "#4b696d"),
           wibox.container.background(wibox.container.margin(wibox.widget { bat.widget, layout = wibox.layout.align.horizontal }, 0, 0), gl_light_aqua),

	--weather
            arrow(gl_light_aqua, gl_light_orange),
           wibox.container.background(wibox.container.margin(wibox.widget {  theme.weather.widget, theme.weather.icon, layout = wibox.layout.align.horizontal }, 0, 0), gl_light_orange),
	    ...
	    -- clock
            arrow(gl_light_orange, gl_dark_gray),
            wibox.container.background(wibox.container.margin(wibox.widget {mydate, layout = wibox.layout.align.horizontal }, 0, 0), gl_dark_gray),
            arrow(gl_dark_gray, gl_dark_purple),
            --wibox.container.background(wibox.container.margin(binclock.widget, 4, 8), "#777E76"),
            wibox.container.background(wibox.container.margin(mytime, 1, 1), gl_dark_purple),
            --]]
        },
    }
end
